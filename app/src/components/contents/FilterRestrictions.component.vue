<template>
  <div class="filters">
    <p>
      <label>Fecha</label>
      <input type="date" class="form-control datepicker" v-bind:min="currentDate" v-model="selectedDate" @change="selectDate">
    </p>
    <div class="selects">
      <p>
        <label>Ciudad</label>
        <select :disabled="!cities || cities.length <= 0" @change="selectCity">
      ...
      <p>
        <label>Tipo</label>
        <select :disabled="!types || types.length <= 0" @change="selectType">
